...
export default function CartItem(){
    ...
    return(
        <View style={{ height: 170, width: 353, backgroundColor: "white", borderRadius: 20, elevation: 3, marginTop: 10, alignSelf: 'center'}}>
        <Text style={{ marginTop: 20, marginLeft: 20, fontSize: 18, fontFamily: "Poppins-SemiBold", color: "black" }}>McDonalds</Text>
